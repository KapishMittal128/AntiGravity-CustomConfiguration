---
name: graphify
description: "any input (code, docs, papers, images, videos) to knowledge graph. Use when user asks any question about a codebase, documents, or project content."
version: "1.0.0"
...
Use when:
- Analyzing a codebase or corpus of documents to understand structures and relationships.
- Generating persistent knowledge graphs from multi-file inputs.

Do NOT use when:
- Performing simple single-file edits or simple search/grep operations.
...
- GraphRAG-ready JSON graph data (`graphify-out/graph.json`)
- Detailed plain-language graph report (`graphify-out/GRAPH_REPORT.md`)
