---
description: Conduct structured technical research and produce an evidence-based recommendation using the Antigravity OS research workflow. Triggers .agents/commands/research.md.
---
